...
**Methods:**
- get_overlapping_areas() -> Area3D[] - Returns a list of intersecting Area3Ds.
- get_overlapping_bodies() -> Node3D[] - Returns a list of intersecting PhysicsBody3Ds, SoftBody3Ds, and GridMaps.
- has_overlapping_areas() -> bool - Returns `true` if intersecting any Area3Ds, otherwise returns `false`.
- has_overlapping_bodies() -> bool - Returns `true` if intersecting any PhysicsBody3Ds, SoftBody3Ds, or GridMaps, otherwise returns `false`.
- overlaps_area(area: Node) -> bool - Returns `true` if the given Area3D intersects or overlaps this Area3D, `false` otherwise.
- overlaps_body(body: Node) -> bool - Returns `true` if the given physics body intersects or overlaps this Area3D, `false` otherwise.
