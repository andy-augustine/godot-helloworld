...
- restart(keep_seed: bool = false) - Restarts the particle emitter.
- set_param_curve(param: int, curve: Curve) - Sets the Curve of the parameter specified by `Parameter`.
