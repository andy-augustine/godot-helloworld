...
**Methods:**
- set_point_cloud(point_cloud: PackedVector2Array) - Based on the set of points provided, this assigns the `points` property using the convex hull algorithm, removing all unneeded points.
