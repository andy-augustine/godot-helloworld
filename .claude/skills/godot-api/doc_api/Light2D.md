...
**Methods:**
- get_height() -> float - Returns the light's height, which is used in 2D normal mapping.
- set_height(height: float) - Sets the light's height, which is used in 2D normal mapping.
