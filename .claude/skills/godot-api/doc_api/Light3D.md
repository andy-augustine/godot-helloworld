...
**Methods:**
- get_correlated_color() -> Color - Returns the Color of an idealized blackbody at the given `light_temperature`.
- get_param(param: int) -> float - Returns the value of the specified `Light3D.
- set_param(param: int, value: float) - Sets the value of the specified `Light3D.
