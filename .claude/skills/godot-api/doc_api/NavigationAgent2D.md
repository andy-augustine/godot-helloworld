...
- get_current_navigation_path() -> PackedVector2Array - Returns this agent's current path from start to finish in global coordinates.
...
- set_velocity_forced(velocity: Vector2) - Replaces the internal velocity in the collision avoidance simulation with `velocity`.
