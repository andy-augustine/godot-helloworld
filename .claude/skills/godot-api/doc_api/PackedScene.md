...
- instantiate(edit_state: int = 0) -> Node - Instantiates the scene's node hierarchy.
- pack(path: Node) -> int - Packs the `path` node, and all owned sub-nodes, into this PackedScene.
